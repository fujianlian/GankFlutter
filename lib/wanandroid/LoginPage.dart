...
import 'package:flutter_gank/wanandroid/RegisterPage.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget _layout() {
    return new Column(
      ...
      children: <Widget>[
        new Padding(
          padding: new EdgeInsets.fromLTRB(20.0, 30.0, 20.0, 25.0),
          child: new Row(
        ...
        GestureDetector(
          ...
          child: Text("注册",style: new TextStyle(color: c1, fontSize: 16.0),),
        ),
      ],
    );
  }
